...
By **March 15th,** you will need to find a partner in class and choose a topic to research and present. You will need to turn in:
...
- 1 related software tools with their documentation
...
- Go (Golang) computer language, Scala - as relates to big data


### where do I find research papers?
- Internet searches on your topic will take you far here, there are a lot of full PDFs available for download, especially for industry white papers.
...
- The bibliography due on March 15th is just the list of sources, containing details like publication date, author, etc. 
...
- 1 short (7 min. max) follow-up presentation, in-person on the last day of class, 1 presentation per group (May 13th)
