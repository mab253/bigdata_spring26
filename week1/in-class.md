...
- The small red piece is just for you to illustrate, you can use it as a pointer to highlight parts of the system as you talk it through with your group.
...
3. What does the namenode remember after a reboot, if the whole cluster shuts down?
...
7. How big is that smaller orange file? How much space does it take up in the DFS?
