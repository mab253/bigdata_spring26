...
- [more resources](https://github.com/mab253/bigdata_spring26/blob/main/week1/resources.md) for GFS/HDFS
...
- [more resources](https://github.com/mab253/bigdata_spring26/blob/main/week2/resources.md) for MapReduce
...
- [more resources](https://github.com/mab253/bigdata_spring26/blob/main/week3+4/resources.md) for Spark, PySpark, Python, etc.
...
**Recommended:**
- [more resources](https://github.com/mab253/bigdata_spring26/blob/main/week3+4/resources.md) for PySpark, Python, SQL etc.
...
**📚 [bibliography + symposium proposal](https://github.com/mab253/bigdata_spring26/blob/main/symposium.md) DUE by Sunday March 15th, 11:59pm**
...
- weekly: [Discord log post](https://github.com/mab253/bigdata_spring26/blob/main/discord.md), due 4:30pm EST *before* every class session, starting Week 1 (or, Saturday 12pm on asynchronous weeks)
...
- You may use Generative AI to improve code and generate lines of code within a larger assignment - **however, you must [cite](https://github.com/mab253/bigdata_spring26/blob/main/ai-citations.md) the tool you used**.
- You may **NOT** use Generative AI without [citation](https://github.com/mab253/bigdata_spring26/blob/main/ai-citations.md) 
...
👾 Our class will have a [Discord](https://github.com/mab253/bigdata_spring26/blob/main/discord.md) server for posting questions and communicating with each other.
